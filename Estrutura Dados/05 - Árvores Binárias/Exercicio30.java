...
/**
 * Elaborar um programa em linguagem Java capaz de armazenar itens numéricos e
 * inteiros em NÓS de uma estrutura de dados do tipo ÁRVORE BINÁRIA. O operador
 * deverá digitar os valores para os itens seguindo a regra de Acesso
...
public class Exercicio30 {
	...
	public static class Arvore {
		...
		public void listTree(String type) {
			...
			if (type.equals("ordered")) this.ordered(this.raiz);
		}
	...
	public static void main(String[] args) {
		...
		while (option != 'c') {
			...
			System.out.println("b) Apresentar Ordenado");
